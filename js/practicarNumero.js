      ...
      window.divs.push(
        {
          html: `
            <div class="flex items-center h-full w-7/12"">
              ...
              <p id="mensajeExcelenteTerminar" class="hidden">¡Felicidades!. Terminaste el módulo Practicar Número. Presione 1 para terminar y regresar al menú de Practicar.</p>
