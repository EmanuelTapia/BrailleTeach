      ...
      window.divs.push(
        {
          html: `
            <div class="flex items-center h-full w-7/12"">
              ...
              <p id="mensajeExcelenteTerminar" class="hidden">¡Felicidades!. Terminaste el módulo Practicar Signo. Presione 1 para obtener tu puntuación.</p>
...
function siguienteModulo() {
  ...
  if (rpta) {
      ...
      if (cont === window.divs.length - 1) {
          window.location.replace("./resultadoPracticarSigno.html");
      } else {
          cont++;
          contNum++;
          mostrarModulo();
